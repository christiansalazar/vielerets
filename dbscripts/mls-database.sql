...
CREATE  TABLE IF NOT EXISTS `mls_property` (
  ...
  `list_agent_email` VARCHAR(50),
  `list_agent_full_name` VARCHAR(50),
  `list_agent_mlsid` VARCHAR(20),
  `list_agent_mui` VARCHAR(20),
  `list_office_head_office_mui` VARCHAR(20),
  `list_office_mlsid` VARCHAR(20),
  `list_office_name` VARCHAR(50),
  `list_office_phone` VARCHAR(30),
  `list_office_mui` VARCHAR(20),
  `listing_contract_date` VARCHAR(50),
  `listing_type` VARCHAR(50),
  `legal_description` VARCHAR(140),
  `legal_subdivision_name` VARCHAR(50),
  `hoa_fee` VARCHAR(20),
  `hoa_payment_schedule` VARCHAR(50),
  `realtor_only_remarks` BLOB,
